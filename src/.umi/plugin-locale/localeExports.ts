...
import {
  ...
  IntlShape,
  MessageDescriptor,
} from '/Users/fingo/Downloads/fingo-boss/node_modules/react-intl';
import { ApplyPluginsType } from 'umi';
import { event, LANG_CHANGE_EVENT } from './locale';
// @ts-ignore
import warning from '/Users/fingo/Downloads/fingo-boss/node_modules/warning/warning.js';

import { plugin } from '../core/umiExports';

export * from '/Users/fingo/Downloads/fingo-boss/node_modules/react-intl';
...
export const localeInfo: {[key: string]: any} = {
  'en-US': {
    messages: {
      ...((locale) => locale.__esModule ? locale.default : locale)(require('/Users/fingo/Downloads/fingo-boss/src/locales/en-US.ts')),
    },
    locale: 'en-US',
    antd: {
  ...
  'pt-BR': {
    messages: {
      ...((locale) => locale.__esModule ? locale.default : locale)(require('/Users/fingo/Downloads/fingo-boss/src/locales/pt-BR.ts')),
    },
    locale: 'pt-BR',
    antd: {
  ...
  'zh-CN': {
    messages: {
      ...((locale) => locale.__esModule ? locale.default : locale)(require('/Users/fingo/Downloads/fingo-boss/src/locales/zh-CN.ts')),
    },
    locale: 'zh-CN',
    antd: {
  ...
  'zh-TW': {
    messages: {
      ...((locale) => locale.__esModule ? locale.default : locale)(require('/Users/fingo/Downloads/fingo-boss/src/locales/zh-TW.ts')),
    },
    locale: 'zh-TW',
    antd: {
