...
const { Option } = Select;
const TeamMemberList = React.forwardRef((props, ref) => {
    const columns2 = [
        {
            title: '用户Id',
            dataIndex: 'userId',
        ...
        <ViewContainer>
            <div className={styles['container']}>
                ...
                >
                    ...
                    <Form.Item label="昵称：" name="nickname" className={styles['ant-form-item']}>
                        <Input placeholder="请输入昵称" allowClear />
                    </Form.Item>
                    <Form.Item label="手机号：" name="mobile" className={styles['ant-form-item']}>
